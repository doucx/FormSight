  ...
  return (
    <div className="bg-card border border-border shadow-sm p-5 sm:p-6 rounded-3xl flex flex-col gap-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 pb-2 border-b border-border/60">
        ...
        <div className="flex items-center gap-1.5 text-xs text-muted-foreground font-medium self-end sm:self-auto">
      ...
      >
        <div ref={matrixContainerRef} className="relative inline-flex gap-2 min-w-max">
          ...
          <div className="flex flex-col justify-between pt-5 pb-0.5 pr-1 text-xs font-semibold text-muted-foreground font-mono select-none h-[126px]">
          ...
          <div className="flex gap-1" onMouseLeave={() => setHoveredDay(null)}>
            {weeks.map((week) => (
              <div key={week.id} className="flex flex-col gap-1 flex-shrink-0">
                ...
                <div className="h-5 relative text-xs font-bold text-muted-foreground">
                  {week.monthLabel && (
